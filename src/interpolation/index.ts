...
export const Interpolation = new class Interpolation {
   ...
   * @returns {number}
   */
   easeInCubic (options: InterpolationOptions): number {
   ...
   * @returns {number}
   */
   easeInOutCubic (options: InterpolationOptions): number {
   ...
   * @returns {number}
   */
   easeOutCubic (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
    options.currentTime--;
   ...
   * @param {InterpolationOptions} options
   */
  linear (options: InterpolationOptions): number {
   ...
   * @returns {number}
   */
  easeInOutQuad (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime/2;
   ...
   * @returns {number}
   */
  public easeInQuad (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
   ...
   * @returns {number}
   */
  easeOutQuad (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
   ...
   * @returns {number}
   */
  easeInQuart (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
   ...
   * @returns {number}
   */
  easeOutQuart (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
    options.currentTime--;
   ...
   * @returns {number}
   */
  easeInOutQuart (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime/2;
   ...
   * @returns {number}
   */
  easeInQuint (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
   ...
   * @returns {number}
   */
  easeOutQuint (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
    options.currentTime--;
   ...
   * @returns {number}
   */
  easeInOutQuint (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime/2;
   ...
   * @returns {number}
   */
  easeInSine (options: InterpolationOptions): number {
   ...
   * @returns {number}
   */
  easeOutSine (options: InterpolationOptions): number {
   ...
   * @returns {number}
   */
  easeInOutSine (options: InterpolationOptions): number {
   ...
   * @returns {number}
   */
  easeInExpo (options: InterpolationOptions): number {
   ...
   * @returns {number}
   */
  easeOutExpo (options: InterpolationOptions): number {
    return options.finishAt * ( -Math.pow( 2, -10 * options.currentTime/options.durationTime ) + 1 ) + options.startAt;
  }
  /**
   * @author Paulo Vernetti - https://github.com/PauloVernetti
   ...
   * @returns {number}
   */
  easeInOutExpo (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime/2;
   ...
   * @returns {number}
   */
  easeInCirc (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
   ...
   * @returns {number}
   */
  easeOutCirc (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime;
    options.currentTime--;
   ...
   * @returns {number}
   */
  easeInOutCirc (options: InterpolationOptions): number {
    options.currentTime /= options.durationTime/2;
